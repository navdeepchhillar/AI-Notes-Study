...
const GenerateMindMapDialog = ({ files, onClose, onSuccess }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      setLoading(true);
      await axios.post(`${API}/generate-mindmap`, {
      ...
      toast.error(typeof detail === "string" ? detail : "Failed to generate mind map");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div
        data-testid="generate-mindmap-dialog"
      ...
      >
        ...
        <div className="border-t-2 border-black p-6 bg-[#F4F4F0]">
          <button
            data-testid="submit-generate-mindmap"
...
export default GenerateMindMapDialog;